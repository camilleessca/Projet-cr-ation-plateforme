    ...
    delete: function (req, res) {
       ...
       //Fonction connect
        ...
        console.log('pwd : ' + connect_json.pwd);
            ...
            User.findOne({'email' : connect_json.email, 'pwd' : connect_json.pwd},
            function(err, checkUsers){
                  if(!checkUsers){
                      console.log('Erreur authentification');
                  // redirection vers page d'accueil
                      res.send('Il y avec une erreur dans l\'email ou le mot de passe')
                  }
                  else{
                      ...
                      //on compare les deux
                    if(password == checkPass && mail == checkMail){
